...
elgg_push_breadcrumb(elgg_echo('tidypics:mostviewedlastmonth'));
...
if (elgg_get_plugin_setting('slideshow', 'tidypics') && !empty($result)) {
	...
	$url = elgg_get_site_url() . "photos/mostviewedlastmonth?limit=64&offset=$offset&view=rss";
...
if (!empty($result)) {
	...
	$area2 = elgg_echo('tidypics:mostviewedlastmonth:nosuccess');
}
...
// Draw it
echo elgg_view_page(elgg_echo('tidypics:mostviewedlastmonth'), $body);
